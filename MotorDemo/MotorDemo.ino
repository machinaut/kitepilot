...
const long min_ups = 50; // max speed
const long usec_per_ups = 100; // "acceleration?" (usec / (usec/step))
const long usec_per_ctrl = 50000; // control rate for serial i/o etc
const long close_pos = 300;
...
void loop() {
  ...
  if(interval_ctrl > usec_per_ctrl) {
    ...
    // go toward goal until close enough
